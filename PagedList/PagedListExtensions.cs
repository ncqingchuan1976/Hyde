...
namespace PagedList
{
    ...
    public static class PagedListExtensions
    {
        ...
        /// <returns></returns>
        public static IPagedList<C> CastPagedList<T, C>(this IPagedList<T> superset, Func<T, C> Mapper)
        {
            var temp = superset.Select(t => Mapper(t));
            return new PagedList<C>(temp)
            {
                PageNumber = superset.PageNumber,
                PageSize = superset.PageSize,
                FirstItemOnPage = superset.FirstItemOnPage,
                IsFirstPage = superset.IsFirstPage,
                IsLastPage = superset.IsLastPage,
                TotalItemCount = superset.TotalItemCount,
                HasNextPage = superset.HasNextPage,
                PageCount = superset.PageCount,
                HasPreviousPage = superset.HasPreviousPage,
                LastItemOnPage = superset.LastItemOnPage
            };
        }
