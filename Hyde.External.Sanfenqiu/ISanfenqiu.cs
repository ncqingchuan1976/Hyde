...
namespace Hyde.External.Sanfenqiu
{
    ...
    public interface ISanfenqiu : IExternal
    {
        ...
        operateResult<responseSanfenqiuOrder> GetOrderList(string sign, int? page = null, int? page_num = null, string order_ids = null, string order_sns = null, string other_order_sn = null, string consignee = null, string mobile = null, int? fromtime = null);
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        operateResult<responseSanfenqiuStockChange> GetStockChange(string sign, string starttime = null, string endtime = null);
